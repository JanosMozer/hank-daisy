            ...
            items(order.diagnoses, key = { it.id }) { d ->
                Column(
                    ...
                    Text(
                        ...
                        color =
                            when (d.outcome) {
                                com.meta.wearable.dat.externalsampleapps.cameraaccess.session.DiagnosisOutcome.PASS ->
                                    AppColors.Accent
                                com.meta.wearable.dat.externalsampleapps.cameraaccess.session.DiagnosisOutcome.FAIL ->
