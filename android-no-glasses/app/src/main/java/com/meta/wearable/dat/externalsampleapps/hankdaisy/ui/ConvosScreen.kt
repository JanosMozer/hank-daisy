...
/**
 * Landing tab for starting a live, phone-camera conversation.
...
fun ConvosScreen(
    ...
    // never kicked off (camera permission revoked, camera unavailable, etc.).
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Live calls with Hank, through your phone camera.",
            ...
            Column(
                ...
                Text(
                    text =
                        "Starts the live stream from your phone camera and " +
                            "opens the voice loop with Hank. He sees what the camera sees " +
                ...
                Text(
                    text =
                        "Past conversations show up under the Chats tab. For voice-only " +
                            "Hank, use the Chats tab's + button.",
        ...
        if (timedOut) {
            Box(
                ...
                Text(
                    text =
                        "Couldn't start the phone camera stream. Check that Camera permission " +
                            "is granted, then tap + again.",
